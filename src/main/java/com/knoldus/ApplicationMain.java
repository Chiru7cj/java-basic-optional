...
class ApplicationMain {
    ...
    public static void main(final String[] args) {
        ...
        Student student1 = new Student("Chiranjeev", student1RollNo, Optional.of("Java"));
        Student student2 = new Student("Anushka", student2RollNo, Optional.empty());
        Student student3 = new Student("Chiru", student3RollNo, Optional.empty());
        ...
        Student student6 = new Student("Bittu", student6RollNo, Optional.of("React"));
        Student student7 = new Student("Ashu", student7RollNo, Optional.of("Angular"));
        Student student8 = new Student("Priya", student8RollNo, Optional.of("Python"));
        Student student9 = new Student("Vini", student9RollNo, Optional.of("Angular"));
        Student student10 = new Student("Aman", student10RollNo, Optional.of("Spring"));
